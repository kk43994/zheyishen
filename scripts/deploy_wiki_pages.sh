...
#
# 只负责六个分类页（boss/bestiary/items/voices/world/vfx）与其资产
...
ROOT=/opt/zheyishen
V=$(date +%Y%m%d%H%M)
PAGES=(boss bestiary items voices world vfx)
...
echo "③ 线上自检"
for u in "wiki/boss.html" "wiki/items.html" "wiki/voices.html" "wiki/bestiary.html" "wiki/world.html" "wiki/vfx.html"; do
...
echo "完成 · v=$V · https://shen.kk666.best/wiki/boss.html"

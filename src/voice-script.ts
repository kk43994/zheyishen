...
const VOICE_DELIVERY: Record<VoiceCueId, DeliverySpec> = {
  ...
  'landlord-rent-deposit': { voice: '中年女声', tone: '直接报条件', emotion: 'calm', speed: 1.10, pitch: -1, intensity: 'medium' },
  ...
  'phone-hospital-not-call': { voice: '忙碌护士女声', tone: '只陈述病人的原话，不加同情腔', emotion: 'calm', speed: 1.10, pitch: 0, intensity: 'medium' },
  ...
  'hospital-family-needed': { voice: '忙碌护士女声', tone: '礼貌、信息密度高', emotion: 'calm', speed: 1.15, pitch: 0, intensity: 'medium' },
  ...
  'hero-became-him': { voice: '成年主角男声', tone: '先脱口而出，再听见自己', emotion: 'fearful', speed: 0.78, pitch: -1, intensity: 'low' },
  'self-stand-straight': { voice: '成年主角男声', tone: '复刻父亲的短促节奏', emotion: 'calm', speed: 0.84, pitch: -1, intensity: 'medium' },
  'self-for-your-good': { voice: '成年主角男声', tone: '越平静越冷', emotion: 'calm', speed: 0.82, pitch: -1, intensity: 'medium' },
  'office-badge-denied': { voice: '门禁系统女声', tone: '短促、字头清晰', emotion: 'calm', speed: 1.08, pitch: 0, intensity: 'medium' },
  'office-meeting-continues': { voice: '成年同事女声', tone: '隔门继续开会', emotion: 'calm', speed: 1.12, pitch: 0, intensity: 'medium' },
  ...
  'clinic-blood-pressure': { voice: '中年医生女声', tone: '日常复测交代', emotion: 'calm', speed: 1.02, pitch: -1, intensity: 'medium' },
  'coworker-cardboard-box': { voice: '成年同事男声', tone: '真的不知道，轻微疑问', emotion: 'surprised', speed: 0.98, pitch: 0, intensity: 'low' },
  'security-return-card': { voice: '中年保安男声', tone: '办理流程，不抬高情绪', emotion: 'calm', speed: 0.92, pitch: -1, intensity: 'medium' },
  'clinic-next-number': { voice: '门诊叫号女声', tone: '重复劳动式清晰播报', emotion: 'calm', speed: 1.08, pitch: 0, intensity: 'medium' },
  'pharmacist-after-meals': { voice: '中年药师女声', tone: '清楚拆分服药步骤', emotion: 'calm', speed: 1.06, pitch: -1, intensity: 'medium' },
  'neighbor-corridor-light': { voice: '年长邻居女声', tone: '隔门闲话，具体温和', emotion: 'calm', speed: 0.85, pitch: -1, intensity: 'low' },
  'hospital-family-late': { voice: '忙碌护士女声', tone: '确认流程，不带同情腔', emotion: 'calm', speed: 1.05, pitch: 0, intensity: 'medium' },
  ...
  'lamp-one-returned': { voice: '低沉年长男声', tone: '保管员办理手续', emotion: 'calm', speed: 0.76, pitch: -2, intensity: 'low' },
  'lamp-pockets-empty': { voice: '低沉年长男声', tone: '不催促，句间留白', emotion: 'calm', speed: 0.74, pitch: -2, intensity: 'low' },
  'narrator-final-breath': { voice: '低沉中老年男声', tone: '比开场更轻，句尾放下', emotion: 'sad', speed: 0.72, pitch: -2, intensity: 'low' },
};
...
export const VOICE_CUES: Record<VoiceCueId, VoiceCue> = {
  ...
  'hospital-family-needed': cue('hospital-family-needed', 3, 'nurse', '家属您好，您父亲已经收住院了。<#0.15#>麻烦尽快过来办理陪护手续。', '护士电话口径，礼貌、忙碌。', 'phone', trigger('enemy_count', '累计击败3个未接来电，或成年章第26秒仍未响起', true, 2), '交代父亲为何在成年章重新出现。'),
  ...
  'hero-became-him': cue('hero-became-him', 3, 'hero', '我也是……<#0.80#>(exhale)为你好。', '先脱口而出，停顿后才听见自己。', 'memory', trigger('stage_enter', '成年章入场，主角第一次听见自己说出旧句', true, 3, true), '少年从父亲那里听见的话，到成年才从主角嘴里回来。'),

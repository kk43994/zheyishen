export type VoiceCueId =
  ...
  | 'lamp-one-returned' | 'lamp-pockets-empty' | 'narrator-final-breath';
...
const VOICE_DELIVERY: Record<VoiceCueId, DeliverySpec> = {
  'narrator-opening': { voice: '低沉中老年男声', tone: '白描，句尾轻收', emotion: 'calm', speed: 0.84, pitch: -2, intensity: 'low' },
  'narrator-start-breath': { voice: '低沉中老年男声', tone: '像补记事实', emotion: 'calm', speed: 0.88, pitch: -2, intensity: 'low' },
  'child-under-bed': { voice: '自然男童声', tone: '贴近耳语，疑问上扬很轻', emotion: 'fearful', speed: 0.91, pitch: 1, intensity: 'low' },
  'caregiver-lights-out': { voice: '成年女声', tone: '门外日常叮嘱', emotion: 'calm', speed: 0.98, pitch: 0, intensity: 'low' },
  'caregiver-no-monster': { voice: '成年女声', tone: '困倦但不嘲笑', emotion: 'calm', speed: 0.94, pitch: 0, intensity: 'low' },
  'father-childhood-walk': { voice: '克制中年男声', tone: '短句落下后转身', emotion: 'calm', speed: 0.88, pitch: -2, intensity: 'low' },
  'classmate-family-late': { voice: '自然男童声', tone: '随口询问，轻微上扬', emotion: 'surprised', speed: 1.01, pitch: 1, intensity: 'low' },
  ...
  'teacher-last-row': { voice: '成熟女教师声', tone: '平静点名，不带训斥腔', emotion: 'calm', speed: 0.94, pitch: 0, intensity: 'medium' },
  'teacher-answer-format': { voice: '成熟女教师声', tone: '重复熟悉规定', emotion: 'calm', speed: 0.98, pitch: 0, intensity: 'medium' },
  'classmate-score-whisper': { voice: '少年男声', tone: '近处压低声音，不笑', emotion: 'surprised', speed: 0.95, pitch: 1, intensity: 'low' },
  'teacher-paper-back': { voice: '成熟女教师声', tone: '课堂顺手交代', emotion: 'calm', speed: 1.00, pitch: 0, intensity: 'medium' },
  'father-for-your-good': { voice: '克制中年男声', tone: '不容讨论的家常话', emotion: 'calm', speed: 0.86, pitch: -2, intensity: 'medium' },
  'school-bell-end': { voice: '校园广播女声', tone: '标准播报，无重音', emotion: 'calm', speed: 1.00, pitch: 0, intensity: 'medium' },
  'recruiter-arrival-time': { voice: '职业女性声', tone: '礼貌快速的流程问题', emotion: 'calm', speed: 1.04, pitch: 0, intensity: 'medium' },
  'landlord-rent-deposit': { voice: '中年女声', tone: '直接报条件', emotion: 'calm', speed: 1.00, pitch: -1, intensity: 'medium' },
  'last-bus-arrival': { voice: '交通广播女声', tone: '标准站内播报', emotion: 'calm', speed: 0.98, pitch: 0, intensity: 'medium' },
  'station-yellow-line': { voice: '交通广播女声', tone: '清楚的安全提醒', emotion: 'calm', speed: 1.02, pitch: 0, intensity: 'medium' },
  'station-doors-closing': { voice: '交通广播女声', tone: '略快但不制造恐慌', emotion: 'calm', speed: 1.06, pitch: 0, intensity: 'medium' },
  'last-bus-departed': { voice: '交通广播女声', tone: '运营结束的标准口径', emotion: 'calm', speed: 0.97, pitch: 0, intensity: 'medium' },
  'interview-thank-you': { voice: '职业女性声', tone: '礼貌收尾，不暗示嘲讽', emotion: 'calm', speed: 1.00, pitch: 0, intensity: 'medium' },
  'phone-wife-fridge': { voice: '三十岁左右成年女声', tone: '平、略疲，不埋怨', emotion: 'calm', speed: 0.95, pitch: 0, intensity: 'low' },
  'phone-hospital-not-call': { voice: '忙碌护士女声', tone: '只陈述病人的原话，不加同情腔', emotion: 'calm', speed: 1.02, pitch: 0, intensity: 'medium' },
  'phone-mother-didnt-ask': { voice: '六十岁左右女性声', tone: '轻声把父亲瞒着的事说出来，不哭', emotion: 'sad', speed: 0.90, pitch: -1, intensity: 'low' },
  'phone-cannot-connect': { voice: '电话系统女声', tone: '合成提示，字头清晰', emotion: 'calm', speed: 1.00, pitch: 0, intensity: 'medium' },
  'family-dinner-cold': { voice: '成年女声', tone: '普通询问，句尾等待回答', emotion: 'sad', speed: 0.92, pitch: -1, intensity: 'low' },
  'hospital-family-needed': { voice: '忙碌护士女声', tone: '礼貌、信息密度高', emotion: 'calm', speed: 1.03, pitch: 0, intensity: 'medium' },
  'father-adult-phone': { voice: '克制中老年男声', tone: '把需要收回句尾', emotion: 'calm', speed: 0.84, pitch: -2, intensity: 'low' },
  'phone-coworker-group': { voice: '成年同事男声', tone: '快、客气，像补一条工作提醒', emotion: 'calm', speed: 1.02, pitch: 0, intensity: 'medium' },
  'hero-not-busy': { voice: '成年主角男声', tone: '照着父亲的停顿说完，自己没有意识到', emotion: 'calm', speed: 0.90, pitch: -1, intensity: 'low' },
  'hero-became-him': { voice: '成年主角男声', tone: '先脱口而出，再听见自己', emotion: 'fearful', speed: 0.84, pitch: -1, intensity: 'low' },
  'self-stand-straight': { voice: '成年主角男声', tone: '复刻父亲的短促节奏', emotion: 'calm', speed: 0.88, pitch: -1, intensity: 'medium' },
  'self-for-your-good': { voice: '成年主角男声', tone: '越平静越冷', emotion: 'calm', speed: 0.86, pitch: -1, intensity: 'medium' },
  'office-badge-denied': { voice: '门禁系统女声', tone: '短促、字头清晰', emotion: 'calm', speed: 1.04, pitch: 0, intensity: 'medium' },
  'office-meeting-continues': { voice: '成年同事女声', tone: '隔门继续开会', emotion: 'calm', speed: 1.02, pitch: 0, intensity: 'medium' },
  'manager-tonight-hard': { voice: '成年经理男声', tone: '随口安排任务', emotion: 'calm', speed: 1.00, pitch: -1, intensity: 'medium' },
  'bank-payment-due': { voice: '客服女声', tone: '标准提醒，不威胁', emotion: 'calm', speed: 1.00, pitch: 0, intensity: 'medium' },
  'clinic-blood-pressure': { voice: '中年医生女声', tone: '日常复测交代', emotion: 'calm', speed: 0.98, pitch: -1, intensity: 'medium' },
  'coworker-cardboard-box': { voice: '成年同事男声', tone: '真的不知道，轻微疑问', emotion: 'surprised', speed: 0.98, pitch: 0, intensity: 'low' },
  'security-return-card': { voice: '中年保安男声', tone: '办理流程，不抬高情绪', emotion: 'calm', speed: 0.96, pitch: -1, intensity: 'medium' },
  'clinic-next-number': { voice: '门诊叫号女声', tone: '重复劳动式清晰播报', emotion: 'calm', speed: 1.00, pitch: 0, intensity: 'medium' },
  'pharmacist-after-meals': { voice: '中年药师女声', tone: '清楚拆分服药步骤', emotion: 'calm', speed: 0.96, pitch: -1, intensity: 'medium' },
  'neighbor-corridor-light': { voice: '年长邻居女声', tone: '隔门闲话，具体温和', emotion: 'calm', speed: 0.92, pitch: -1, intensity: 'low' },
  'hospital-family-late': { voice: '忙碌护士女声', tone: '确认流程，不带同情腔', emotion: 'calm', speed: 1.00, pitch: 0, intensity: 'medium' },
  'light-room-keeper': { voice: '年长店主男声', tone: '平常招呼，留出坐下时间', emotion: 'calm', speed: 0.88, pitch: -2, intensity: 'low' },
  'light-room-left-this': { voice: '年长店主男声', tone: '看一眼物件，只说明来历，不神秘化', emotion: 'calm', speed: 0.86, pitch: -2, intensity: 'low' },
  'back-room-keeper': { voice: '年长店主男声', tone: '说明交换条件，不诱惑', emotion: 'calm', speed: 0.87, pitch: -2, intensity: 'low' },
  'lamp-one-returned': { voice: '低沉年长男声', tone: '保管员办理手续', emotion: 'calm', speed: 0.82, pitch: -2, intensity: 'low' },
  'lamp-pockets-empty': { voice: '低沉年长男声', tone: '不催促，句间留白', emotion: 'calm', speed: 0.80, pitch: -2, intensity: 'low' },
  'narrator-final-breath': { voice: '低沉中老年男声', tone: '比开场更轻，句尾放下', emotion: 'sad', speed: 0.78, pitch: -2, intensity: 'low' },
};
...
export const VOICE_CUES: Record<VoiceCueId, VoiceCue> = {
  'narrator-opening': cue('narrator-opening', 0, 'narrator', '(inhale)他还没有名字。<#0.62#>第一口气进来以前，谁也不知道，<#0.38#>这一身会穿上什么。(exhale)', '普通中老年男性，白描、克制、轻微疲惫。', 'clear', trigger('origin_ready', '出生档案文字完全显现', true, 3, true), '确定旁白是暮年的主角本人。'),
  'narrator-start-breath': cue('narrator-start-breath', 0, 'narrator', '后来，他开始呼吸。', '像补记一条事实，不抒情。', 'clear', trigger('stage_enter', '童年章首次开始', true, 2), '把开场按钮变成叙事动作。'),
  ...
  'teacher-last-row': cue('teacher-last-row', 1, 'teacher', '(clear-throat)最后一排。<#0.32#>站起来。', '平静、熟练，禁止反派腔。', 'clear', trigger('enemy_count', '场上首次同时出现6个红叉或碎语敌人', false, 2), '把公开注视变成战斗压力。'),
  ...
  'father-for-your-good': cue('father-for-your-good', 1, 'father', '站好。<#0.42#>都是为你好。', '不怒吼，像一句不容讨论的家常话。', 'memory', trigger('boss_defeat', '统一答案被击败', true, 3, true), '父亲线第二次埋点，成年由主角复述。'),
  ...
  'landlord-rent-deposit': cue('landlord-rent-deposit', 2, 'landlord', '押一付三。<#0.25#>水电另算。', '房东只是在报条件。', 'phone', trigger('shop_open', '青年章第一次进入商城', false, 1), '把商城与租房现实重叠。'),
  ...
  'phone-hospital-not-call': cue('phone-hospital-not-call', 3, 'nurse', '他一直说，<#0.3#>不用叫你。', '护士只转述父亲原话，不替任何人解释。', 'phone', trigger('boss_phase', '响个不停固定第3通：医院', true, 3), '父亲的沉默从家庭习惯变成正在发生的照护事实。'),
  ...
  'hospital-family-needed': cue('hospital-family-needed', 3, 'nurse', '家属您好，您父亲已经收住院了。<#0.25#>麻烦尽快过来办理陪护手续。', '护士电话口径，礼貌、忙碌。', 'phone', trigger('enemy_count', '累计击败3个未接来电，或成年章第26秒仍未响起', true, 2), '交代父亲为何在成年章重新出现。'),
  'father-adult-phone': cue('father-adult-phone', 3, 'father', '(clear-throat)没什么事。<#0.68#>你忙吧。', '与童年“走吧”同音色，句尾收回。', 'phone', trigger('boss_phase', '响个不停固定第6通：父亲回拨', true, 3), '父亲仍然只会把需要说成没事。'),
  'phone-coworker-group': cue('phone-coworker-group', 3, 'coworker', '群里@你了。<#0.24#>你没看到吧。', '快、客气，只确认工作消息。', 'phone', trigger('boss_phase', '响个不停固定第7通：同事', true, 2), '二阶段最后一通把玩家从医院重新拉回工作。'),
  'hero-not-busy': cue('hero-not-busy', 3, 'hero', '没事。<#0.42#>不忙。', '成年主角照着父亲刚才的停顿说完。', 'phone', trigger('boss_defeat', '响个不停结束后的固定第8通：他打给家里', true, 3, true), '用同一句否认闭合父子传承，落在父亲的病历本固定掉落页。'),
  'hero-became-him': cue('hero-became-him', 3, 'hero', '我也是……<#0.55#>(exhale)为你好。', '先脱口而出，停顿后才听见自己。', 'memory', trigger('stage_enter', '成年章入场，主角第一次听见自己说出旧句', true, 3, true), '少年从父亲那里听见的话，到成年才从主角嘴里回来。'),
  'self-stand-straight': cue('self-stand-straight', 3, 'hero', '站好。', '与少年父亲同节奏，但换成主角音色。', 'memory', trigger('stand_still', '成年章第一次停步让湿鞋追近', true, 2), '压力已经内化为主角自己的短句，不借父亲 Boss 发声。'),
  'self-for-your-good': cue('self-for-your-good', 3, 'hero', '我也是为你好。', '不吼，越平静越成立。', 'memory', trigger('stand_still', '成年章第二次停步让湿鞋追近', true, 3, true), '第二次停步把少年听过的完整旧句还到成年主角身上。'),
  ...
  'office-meeting-continues': cue('office-meeting-continues', 4, 'office', '下一页。<#0.25#>这个数字再往下拆一下。', '门后普通会议声。', 'behind-door', trigger('stage_time', '门禁失败后1.2秒', false, 2, false, 1.2), '世界没有为他的离开暂停。'),
  ...
  'clinic-blood-pressure': cue('clinic-blood-pressure', 4, 'doctor', '血压有点高。<#0.2#>坐十分钟再量一次。', '医生日常口径，不制造重病。', 'clear', trigger('hp_below', '中年章生命首次低于50%', false, 1), '身体衰老从普通复测开始。'),
  'coworker-cardboard-box': cue('coworker-cardboard-box', 4, 'coworker', '这个箱子，<#0.22#>是给谁的？', '同事真的不知道。', 'behind-door', trigger('enemy_count', '累计击败4个打包纸箱', false, 1), '不点明裁员，让玩家自己拼起来。'),
  'security-return-card': cue('security-return-card', 4, 'security', '工牌放这儿就行。', '保安办理流程，不看主角。', 'clear', trigger('stage_transition', '中年向暮年过渡开始', true, 2), '工牌离身是暮年的入口。'),

  'clinic-next-number': cue('clinic-next-number', 5, 'nurse', '四十二号，请到三诊室。<#0.3#>陪同家属准备好证件。', '走廊叫号，重复劳动感。', 'pa', trigger('stage_enter', '暮年章第5秒', true, 1, false, 5), '暮年仍然发生在具体地点。'),
  'pharmacist-after-meals': cue('pharmacist-after-meals', 5, 'pharmacist', '这盒一天三次，饭后吃。<#0.22#>和刚才那盒隔开半小时。', '药房交代用法，清晰直接。', 'clear', trigger('shop_open', '暮年章第一次进入药房摊位', false, 1), '让暮年商城成为真实药房。'),
  ...
  'hospital-family-late': cue('hospital-family-late', 5, 'nurse', '家属还在路上吗？', '护士确认流程，不带同情。', 'clear', trigger('hp_below', '暮年章生命首次低于35%', false, 2), '与童年“家里人还没来吗”形成无解释回声。'),
  ...
  'lamp-one-returned': cue('lamp-one-returned', 5, 'lamp-keeper', '这一件，<#0.44#>先还回去。', '像保管员办理手续。', 'clear', trigger('ending_strip', '收灯人第一次剥下道具', true, 3, true), '终局不是打败死神，而是逐件归还。'),
  'lamp-pockets-empty': cue('lamp-pockets-empty', 5, 'lamp-keeper', '口袋空了。<#0.4#>再看看手里。', '不催促，给玩家检查自己的时间。', 'clear', trigger('ending_strip', '最后一件道具离身', true, 3, true), '把注意力从这一身移到一口气。'),
  'narrator-final-breath': cue('narrator-final-breath', 'ending', 'narrator', '(inhale)手里空了。<#0.72#>这一口气，<#0.38#>也可以放下了。(exhale)', '与开场同一音色，更轻。', 'clear', trigger('ending_choice', '所有道具归还后，最后一次攻击重新有效', true, 3, true), '用同一次呼吸闭合开场；玩家再次攻击就是回答。'),
};
...
export const STAGE_VOICE_PRELOADS: ReadonlyArray<ReadonlyArray<VoiceCueId>> = [
  ...
  ['clinic-next-number', 'pharmacist-after-meals', 'neighbor-corridor-light', 'hospital-family-late', 'light-room-keeper', 'light-room-left-this', 'back-room-keeper', 'lamp-one-returned', 'lamp-pockets-empty', 'narrator-final-breath'],
];

...
export const STAGE_VOICE_PRELOADS: ReadonlyArray<ReadonlyArray<VoiceCueId>> = [
  // 开场漫画由 startRun 单独预载；这里前八席必须留给真正即将发生的童年台词。
  ['narrator-start-breath', 'caregiver-lights-out', 'child-under-bed', 'caregiver-no-monster', 'boss-closet-defeat', 'caregiver-school-send', 'caregiver-fell-again', 'narrator-he-fell-asleep', 'narrator-opening', 'origin-comic-01', 'origin-comic-02', 'origin-comic-03', 'origin-comic-04', 'origin-comic-05', 'origin-comic-06', 'origin-comic-07', 'origin-comic-08'],

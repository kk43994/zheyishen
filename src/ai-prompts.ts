...
父亲线是后续章节的固定正典：童年时父亲仍在世，曾在一次放学下雨时把雨衣披给他，只说“走吧”；成年时父亲仍在世，可能因病住院。父亲可以长期缺席、离异后疏远、经济条件悬殊、沉默寡言，也可以不是主要照料者，但不得写成童年前已经去世、完全不存在或与这两件事互相矛盾。母亲、祖辈、继亲和其他照料者仍可自由变化，不要因此把所有家庭写成同一种。

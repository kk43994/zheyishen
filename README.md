...
- **写实的生成式命运连续剧**：事件正文必须先用白话讲清时间、地点、人物、动作与直接结果，物体遵守现实用途和物理性质；年龄阶段不可被旧道具拉回过去，记忆字段不可偷加正文没有的设定。草稿经独立现实审稿，退稿理由会进入下一次重写；因果成立之后才允许灰色幽默与留白。上一次的选择成为下一次的起因，回应改变五毒与后续构筑
